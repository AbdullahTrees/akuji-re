...
const
  ...
  { Types 75 and 76. Type 75 dies with its parent - after the dying check it
    ...
    the two sound triggers are one direction step apart. }
...
begin
  ...
  Inc(E.Raw[EF_BLOCK_B]);
  { The half-period is block A[1]. Both ParamA kinds 'M' and 'R' write this
    field; shipped type-21 placements use 'M'.
